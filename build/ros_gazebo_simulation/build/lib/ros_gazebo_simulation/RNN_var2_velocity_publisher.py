...
def sighandler(signal, frame):
    ...
    np.savetxt("RNN_GRU_var2_output_joint.csv", combined_array, delimiter=",", header="Real_linear, Prediction_linear, Real_angular, Prediction_angular,  joint_state_velocity_x, joint_state_velocity_y")
...
class LidarSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.linear_vel_model = models.load_model('/home/joanna/ros2_gz_sim/neural_networks/RNN_GRU_model_linear_velocity_wariant_2.keras')
        self.angular_vel_model = models.load_model('/home/joanna/ros2_gz_sim/neural_networks/RNN_GRU_model_angular_velocity_wariant_2.keras')
    ...
    def timer_callback(self):
        ...
        for j in range(0, 72, 2):
            self.processed_lidar_data[j] = self.old_lidar_data[l*10]
            self.processed_lidar_data[j+1] = self.present_lidar_data[l*10]
            l += 1
